...
alias dcde='docker-compose -f docker-compose-dev.yml exec'
alias dcdl='docker-compose -f docker-compose-dev.yml logs --tail 1000'
alias dcdr='docker-compose -f docker-compose-dev.yml run'
alias dcdps='docker-compose -f docker-compose-dev.yml ps'
alias dcdrm='docker-compose -f docker-compose-dev.yml rm'
